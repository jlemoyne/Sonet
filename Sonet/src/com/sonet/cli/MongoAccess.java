...
//			MongoClient mongoClient = new MongoClient();
			// or
			mongoClient = new MongoClient( "muon-3.local" , 27017);
			// or
...
//			                                      new ServerAddress("localhost", 27019)));
	...
	public int checkMongod() {
		...
		JSch jsch = new JSch();
		try {
//			jsch.addIdentity("/Users/jclaudel/.ssh/id_dsa");
			Session session = jsch.getSession("gse", "sv2lxgsed03.corp.equinix.com", 22);
...
//		String ssh_host = "sv2lxgsed03.corp.equinix.com";
		String ssh_host = "172.16.209.117";
//		String ssh_user = "gse";
		String ssh_user = "jclaudel";
//		String ssh_password = "welcome1";
